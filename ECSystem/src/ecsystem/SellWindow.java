...
public class SellWindow extends JFrame implements ActionListener, ItemListener {
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (e.getSource() == jBtn1) {
			...
			if (jCheck1.isSelected()) {
				...
				if (jText4.getText().equals(""))
					...
					d1 = Integer.parseInt(jText4.getText());
				...
				if (jText4.getText().equals(""))
					...
					d1 = Double.parseDouble(jText4.getText());
			...
			if (jText31.getText().equals("")) {
				...
				if (jCheck1.isSelected()) {
					...
					if (jText4.getText().equals(""))
						...
						d2 = Integer.parseInt(jText4.getText());
					...
					if (jText4.getText().equals(""))
						...
						d2 = Double.parseDouble(jText4.getText());
		...
		if (e.getSource() == jBtn4) {
			...
			else if (!jText71.getText().equals("")
					&& jText31.getText().equals("")) {
				int g = Integer.parseInt(jText8.getText());
				int h = Integer.parseInt(jText9.getText());
				int i = Integer.parseInt(jText10.getText());
			...
			else if (!jText31.getText().equals("")
					&& jText71.getText().equals(""))// !!!!!!!!!!!!
			{
				int g = Integer.parseInt(jText8.getText());
				int h = Integer.parseInt(jText9.getText());
		...
		if (e.getSource() == jBtn5) {
			...
			if (!(jText31.getText().equals("") && jText71.getText().equals("") && jText101
					.getText().equals(""))) {
			...
			else if (!(jText31.getText().equals("") && jText71.getText()
					.equals("")) && jText101.getText().equals(""))

			{
				...
				if (jCheck1.isSelected()) {
					...
					&& (jText71.getText().equals("") && jText101.getText()
							.equals(""))) {
				...
				if (jCheck1.isSelected()) {
					...
					&& (jText31.getText().equals("") && jText101.getText()
							.equals(""))) {
				if (jCheck1.isSelected()) {
					int d2;
					if (jText4.getText().equals(""))
			...
			} else if (!(jText71.getText().equals("") && jText101.getText()
					.equals("")) && jText31.getText().equals("")) {
			...
			} else if (!(jText31.getText().equals("") && jText101.getText()
					.equals("")) && jText71.getText().equals("")) {
			...
			else if (!jText101.getText().equals("")
					&& (jText31.getText().equals("") && jText71.getText()
							.equals(""))) {
