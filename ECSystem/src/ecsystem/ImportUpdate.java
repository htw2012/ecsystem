 ...
 * @version 1.0
 */
public class ImportUpdate extends JFrame implements ActionListener {
...
//		}
		...
		if (e.getSource() == jBtn3) {
			try {
				if (!rs.isFirst()) {
					...
					JOptionPane.showMessageDialog(null, "已经到顶啦！");
				}
	...
	public void showResul(ResultSet rs) {
		try {
			jText1.setText(rs.getString("Gname"));
			jText2.setText(rs.getString("Gprice"));
			jText3.setText(rs.getString("Gnumber"));
	...
	public static void main(String[] args) {
		ImportUpdate importupdate = new ImportUpdate();
	}
}
